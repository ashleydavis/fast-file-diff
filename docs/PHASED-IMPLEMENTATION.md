...
## - [x] Commit 4: Implement build-pairs — build pairs from left and right arrays
...
## - [x] Commit 5: Implement classify-pairs — classify pairs by size/mtime and build content-check queue
...
## - [x] Commit 6: Implement hash-left and hash-right with shared implementation
...
## - [x] Commit 7: Implement compare-hashes — compare hashes and produce final diff result
...
## - [x] Commit 8: Use phased pipeline as default; remove old path; re-enable smoke tests
